...
class Testls(unittest.TestCase):
    ...
    def test_long_list_enabled(self):
        """
            ...
            The test is commented because when you clone a git repo,
            the last modifications date gets modified. You must change the
            date to your local one in order to passe the test.
        """
        self.maxDiff = None
